...
git subsplit publish --heads="master 3.0" --no-tags src/Wandu/Compiler:git@github.com:Wandu/Compiler.git
...
git subsplit publish --heads="master 3.0" --no-tags src/Wandu/Installation:git@github.com:Wandu/Installation.git
...
git subsplit publish --heads="master 3.0" --no-tags src/Wandu/Support:git@github.com:Wandu/Support.git
