...
git subsplit publish --heads="master 3.0" src/Wandu/DateTime:git@github.com:Wandu/DateTime.git
git subsplit publish --heads="master 3.0" src/Wandu/DI:git@github.com:Wandu/DI.git
...
git subsplit publish --heads="master 3.0" src/Wandu/Validator:git@github.com:Wandu/Validator.git
git subsplit publish --heads="master 3.0" src/Wandu/View:git@github.com:Wandu/View.git
